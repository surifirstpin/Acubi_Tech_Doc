...
| 15 | always_filter | to directly define desired filters values in model itself. <b>for example** define "always_filter": "STATIONCODE IN ('Station_1','Station_2')"  it retrieves only station 1 and station 2 in analysis data section.|
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTc0NTE2MDk0NSwtNzI1ODU3MDk3LDEyNT
